...
- The `tctl` admin tool and `tsh` client tool.
  ...
  Visit [Installation](../../../installation/single-machine/single-machine.mdx) for instructions on downloading `tctl` and `tsh`.
...
integration, like the [Jamf Pro integration](../../../zero-trust-access/device-trust/jamf-integration.mdx).
