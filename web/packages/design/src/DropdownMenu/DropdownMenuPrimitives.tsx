 ...
 *
 * Also used as a submenu trigger — pass the `ref` and
 * `getReferenceProps()` from a nested `DropdownMenu`'s `renderTrigger`.
 */
export const DropdownMenuItem = forwardRef<HTMLElement, DropdownMenuItemProps>(
  function DropdownMenuItem(
    { label, disabled, children, as, ...props },
    forwardedRef
  ) {
 ...
 *
 * Accepts `Text` props (e.g., `typography`, `color`) to style the label
 * text.
 *
 * @example
 * ```tsx
